                      ...
                      <div class="product-description pb-3 mb-3">
                          ...
                          <form class="" action="" method="get">
                            <div class="d-flex flex-row justify-content-center">
                              <div class="p-2">
                                <input class="form-control mr-5" type="number" name="" value="" onkeypress="return OnlyNumber(event)" placeholder="Pilih kuantitas" min="<?php echo $product['minimal_pembelian']; ?>"
